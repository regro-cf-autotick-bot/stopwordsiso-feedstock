...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stopwordsiso-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15509&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stopwordsiso-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stopwordsiso` can be installed with:

```
conda install stopwordsiso
```

It is possible to list all of the versions of `stopwordsiso` available on your platform with:
